...
class EventMemberTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $eventMember = array(
            ...
            ['event_id' => 5, 'member_id' => 4, 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ['event_id' => 5, 'member_id' => 6, 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ...
            ['event_id' => 6, 'member_id' => 10, 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ['event_id' => 6, 'member_id' => 11, 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ...
            ['event_id' => 7, 'member_id' => 6, 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ['event_id' => 7, 'member_id' => 11, 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ...
            ['event_id' => 8, 'member_id' => 13, 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ['event_id' => 8, 'member_id' => 12, 'created_at' => new DateTime, 'updated_at' => new DateTime],
