...
class LootTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $loot = array(
            ...
            ['id' => 12, 'item_lvl' => '220', 'slot' => 'Head', 'name' => 'Unassembled Exarch MK-X Headgear', 'gear_points' => 75, 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ['id' => 13, 'item_lvl' => '220', 'slot' => 'Chest', 'name' => 'Unassembled Exarch MK-X Armor', 'gear_points' => 75, 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ['id' => 14, 'item_lvl' => '220', 'slot' => 'Wrists', 'name' => 'Unassembled Exarch MK-X Bracers', 'gear_points' => 50, 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ['id' => 15, 'item_lvl' => '220', 'slot' => 'Hands', 'name' => 'Unassembled Exarch MK-X Gloves', 'gear_points' => 75, 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ['id' => 16, 'item_lvl' => '220', 'slot' => 'Waist', 'name' => 'Unassembled Exarch MK-X Belt', 'gear_points' => 50, 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ['id' => 17, 'item_lvl' => '220', 'slot' => 'Legs', 'name' => 'Unassembled Exarch MK-X Greaves', 'gear_points' => 75, 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ['id' => 18, 'item_lvl' => '220', 'slot' => 'Feet', 'name' => 'Unassembled Exarch MK-X Boots', 'gear_points' => 75, 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ['id' => 19, 'item_lvl' => '220', 'slot' => 'Offhand', 'name' => 'Unassembled Exarch MK-X Offhand Weapon', 'gear_points' => 75, 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ['id' => 20, 'item_lvl' => '220', 'slot' => 'Implant', 'name' => 'Unassembled Exarch MK-X Implant', 'gear_points' => 50, 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ['id' => 21, 'item_lvl' => '220', 'slot' => 'Ear', 'name' => 'Unassembled Exarch MK-X Earpiece', 'gear_points' => 50, 'created_at' => new DateTime, 'updated_at' => new DateTime],
            ['id' => 22, 'item_lvl' => '220', 'slot' => 'Mainhand', 'name' => 'Unassembled Exarch MK-X Mainhand Weapon', 'gear_points' => 100, 'created_at' => new DateTime, 'updated_at' => new DateTime]
        );
